...
const packages = {
  arknights: {
    ...
    game: 'Arknights',
    items: [
      { label: 'Harian', labelEn: 'Daily', title: 'Daily Clear', desc: 'Login, daily mission, claim reward, dan basic sanity.', descEn: 'Login, daily missions, reward claims, and basic sanity use.', price: '7 ribu', priceEn: '$4', placeholder: 'Contoh: daily clear, claim reward, sanity jangan sampai full.', placeholderEn: 'Example: daily clear, claim rewards, keep sanity from capping.' },
      { label: 'Event', labelEn: 'Event', title: 'Event Rush', desc: 'Progress event, farm material, dan target milestone utama.', descEn: 'Event progress, material farming, and main milestone targets.', price: '12 ribu', priceEn: '$8', featured: true, placeholder: 'Contoh: mau farm event stage tertentu sampai token cukup.', placeholderEn: 'Example: farm a specific event stage until tokens are enough.' },
      { label: 'Annihilation', labelEn: 'Annihilation', title: 'Annihilation', desc: 'Clear mingguan Annihilation untuk reward Orundum.', descEn: 'Weekly Annihilation clear for Orundum rewards.', price: '10 ribu', priceEn: '$6', placeholder: 'Contoh: mau Annihilation weekly, squad sudah siap.', placeholderEn: 'Example: weekly Annihilation, squad is ready.' },
    ],
  },
  endfield: {
    label: '02',
    ...
    items: [
      { label: 'Story', labelEn: 'Story', title: 'Story', desc: 'Progress cerita utama sesuai chapter yang kamu butuhkan.', descEn: 'Main story progress based on the chapter you need.', price: '15 ribu/chapter', priceEn: '$10/chapter', placeholder: 'Contoh: mau story chapter 2 sampai selesai.', placeholderEn: 'Example: finish story chapter 2.' },
      { label: 'Factory', labelEn: 'Factory', title: 'Pabrik + Mining', titleEn: 'Factory + Mining', desc: 'Joki pabrik, setup mining, dan rapihin produksi akun.', descEn: 'Factory boosting, mining setup, and cleaner account production.', price: '25 ribu', priceEn: '$18', featured: true, placeholder: 'Contoh: mau setup mining dan pabrik dibuat rapi.', placeholderEn: 'Example: set up mining and organize the factory.' },
      { label: 'Harian', labelEn: 'Daily', title: 'Daily', desc: 'Login, daily task, claim reward, dan rutinitas ringan.', descEn: 'Login, daily tasks, reward claims, and light routines.', price: '5 ribu', priceEn: '$4', placeholder: 'Contoh: daily Endfield saja, claim reward juga.', placeholderEn: 'Example: Endfield daily only, include reward claims.' },
      { label: 'Mingguan', labelEn: 'Weekly', title: 'Rawat Akun', titleEn: 'Account Care', desc: 'Rawat akun selama satu minggu, termasuk daily rutin.', descEn: 'One week account care, including routine daily tasks.', price: '20 ribu', priceEn: '$15', placeholder: 'Contoh: rawat 2 minggu, mulai Senin.', placeholderEn: 'Example: care for 2 weeks, start Monday.' },
      { label: 'Bulanan', labelEn: 'Monthly', title: 'Rawat Akun', titleEn: 'Account Care', desc: 'Paket rawat akun satu bulan untuk progress lebih hemat.', descEn: 'One month account care for steadier progress.', price: '35 ribu', priceEn: '$42', placeholder: 'Contoh: rawat 1 bulan, daily wajib clear.', placeholderEn: 'Example: care for 1 month, daily must be cleared.' },
    ],
  },
  wuwa: {
    label: '03',
    ...
    items: [
      { label: 'Harian', labelEn: 'Daily', title: 'Daily Clear', desc: 'Login, daily activity, claim reward, dan spend Waveplate.', descEn: 'Login, daily activity, reward claims, and Waveplate spending.', price: '5 ribu', priceEn: '$4', placeholder: 'Contoh: daily WuWa, Waveplate buat material karakter.', placeholderEn: 'Example: WuWa daily, spend Waveplate on character materials.' },
      { label: 'Mingguan', labelEn: 'Weekly', title: 'Weekly Care', desc: 'Rutinitas mingguan ringan termasuk weekly boss atau target stamina.', descEn: 'Light weekly routine including weekly boss or stamina targets.', price: '20 ribu', priceEn: '$15', featured: true, placeholder: 'Contoh: clear weekly boss dan spend Waveplate selama 1 minggu.', placeholderEn: 'Example: clear weekly boss and spend Waveplate for 1 week.' },
      { label: 'Story', labelEn: 'Story', title: 'Main Quest', desc: 'Bantu progres main quest sesuai chapter atau target yang diminta.', descEn: 'Main quest progress based on requested chapter or target.', price: '12 ribu/chapter', priceEn: '$10/chapter', placeholder: 'Contoh: lanjut main quest sampai chapter terbaru.', placeholderEn: 'Example: continue main quest until the latest chapter.' },
      { label: 'Explore', labelEn: 'Explore', title: 'Exploration', desc: 'Exploration map, chest, puzzle, dan target completion area.', descEn: 'Map exploration, chests, puzzles, and area completion targets.', price: 'mulai 50 ribu', priceEn: 'from $35', placeholder: 'Contoh: exploration area tertentu sampai 80%.', placeholderEn: 'Example: explore a specific area up to 80%.' },
    ],
  },
  zzz: {
    label: '04',
    ...
    items: [
      { label: 'Harian', labelEn: 'Daily', title: 'Daily Errand', desc: 'Login, daily task, battery spend, dan claim reward rutin.', descEn: 'Login, daily tasks, battery spending, and routine reward claims.', price: '5 ribu', priceEn: '$4', placeholder: 'Contoh: daily ZZZ dan battery untuk material agent.', placeholderEn: 'Example: ZZZ daily and battery for agent materials.' },
      { label: 'Mingguan', labelEn: 'Weekly', title: 'Weekly Reset', desc: 'Clear target mingguan seperti Hollow, boss, atau objective reset.', descEn: 'Weekly targets such as Hollow, boss, or reset objectives.', price: '25 ribu', priceEn: '$18', featured: true, placeholder: 'Contoh: weekly reset ZZZ sampai reward utama beres.', placeholderEn: 'Example: ZZZ weekly reset until main rewards are done.' },
      { label: 'Story', labelEn: 'Story', title: 'Story Chapter', desc: 'Progress story dan side commission sesuai target akun.', descEn: 'Story and side commission progress based on account targets.', price: '15 ribu/chapter', priceEn: '$10/chapter', placeholder: 'Contoh: clear story chapter 3 sampai selesai.', placeholderEn: 'Example: finish story chapter 3.' },
      { label: 'Rawat', labelEn: 'Care', title: 'Monthly Care', desc: 'Rawat akun satu bulan untuk daily dan rutinitas basic.', descEn: 'One month account care for daily and basic routines.', price: '60 ribu', priceEn: '$45', placeholder: 'Contoh: rawat ZZZ 1 bulan, daily wajib clear.', placeholderEn: 'Example: care for ZZZ for 1 month, daily must be cleared.' },
    ],
  },
  hsr: {
    label: '05',
    ...
    items: [
      { label: 'Harian', labelEn: 'Daily', title: 'Daily Training', desc: 'Login, daily training, claim reward, dan spend Trailblaze Power.', descEn: 'Login, daily training, reward claims, and Trailblaze Power spending.', price: '5 ribu', priceEn: '$4', placeholder: 'Contoh: daily HSR, power untuk relic atau trace.', placeholderEn: 'Example: HSR daily, power for relics or traces.' },
      { label: 'Endgame', labelEn: 'Endgame', title: 'MoC / PF / AS', desc: 'Bantu clear konten endgame sesuai roster dan target bintang.', descEn: 'Endgame clear based on roster and star target.', price: '25 ribu', priceEn: '$20', featured: true, placeholder: 'Contoh: MoC sampai floor tertentu, target semampunya roster.', placeholderEn: 'Example: MoC up to a certain floor, target based on roster.' },
      { label: 'Story', labelEn: 'Story', title: 'Trailblaze Mission', desc: 'Progress misi utama, companion, atau event story.', descEn: 'Main mission, companion, or event story progress.', price: '15 ribu/chapter', priceEn: '$10/chapter', placeholder: 'Contoh: lanjut Penacony sampai quest utama selesai.', placeholderEn: 'Example: continue Penacony until main quest is done.' },
      { label: 'Rawat', labelEn: 'Care', title: 'Monthly Care', desc: 'Paket rawat akun satu bulan untuk daily rutin.', descEn: 'One month account care for routine daily tasks.', price: '55 ribu', priceEn: '$42', placeholder: 'Contoh: rawat HSR 1 bulan, daily dan power jangan cap.', placeholderEn: 'Example: care for HSR for 1 month, daily and power must not cap.' },
    ],
  },
  nte: {
    label: '06',
    ...
    items: [
      { label: 'Harian', labelEn: 'Daily', title: 'Daily City Run', desc: 'Login, daily task, claim reward, dan stamina/resource rutin.', descEn: 'Login, daily tasks, reward claims, and routine stamina/resources.', price: '7 ribu', priceEn: '$5', placeholder: 'Contoh: daily NTE dan resource dipakai buat upgrade.', placeholderEn: 'Example: NTE daily and spend resources for upgrades.' },
      { label: 'Mingguan', labelEn: 'Weekly', title: 'Weekly Care', desc: 'Rutinitas mingguan, boss, dan target reward reset.', descEn: 'Weekly routine, boss, and reset reward targets.', price: '25 ribu', priceEn: '$20', featured: true, placeholder: 'Contoh: weekly NTE sampai reward utama clear.', placeholderEn: 'Example: NTE weekly until main rewards are cleared.' },
      { label: 'Story', labelEn: 'Story', title: 'Story Progress', desc: 'Progress cerita dan quest utama sesuai chapter target.', descEn: 'Story and main quest progress based on target chapter.', price: '20 ribu/chapter', priceEn: '$12/chapter', placeholder: 'Contoh: story chapter 2 sampai selesai.', placeholderEn: 'Example: finish story chapter 2.' },
      { label: 'Explore', labelEn: 'Explore', title: 'City Exploration', desc: 'Explore area, objective, collectible, dan target completion.', descEn: 'Area exploration, objectives, collectibles, and completion targets.', price: 'mulai 60 ribu', priceEn: 'from $40', placeholder: 'Contoh: explore distrik tertentu sampai target completion.', placeholderEn: 'Example: explore a specific district until target completion.' },
    ],
  },
  request: {
    label: '07',
    game: 'Request Joki Lainnya',
    gameEn: 'Custom Boosting Request',
    items: [
      { label: 'Custom', labelEn: 'Custom', title: 'Material Farm', desc: 'Farm material tertentu sesuai kebutuhan upgrade akun.', descEn: 'Farm specific materials based on your upgrade needs.', price: 'Cek via chat', priceEn: 'Quote', placeholder: 'Contoh: farm material skill/operator tertentu, target 50 item.', placeholderEn: 'Example: farm a specific skill/operator material, target 50 items.' },
      { label: 'Custom', labelEn: 'Custom', title: 'Quest Clear', desc: 'Bantu clear misi, objective, exploration, atau stage yang nyangkut.', descEn: 'Help clear missions, objectives, exploration, or stuck stages.', price: 'Cek via chat', priceEn: 'Quote', featured: true, placeholder: 'Contoh: stuck di stage tertentu, minta dibantu sampai clear.', placeholderEn: 'Example: stuck on a certain stage, need help until clear.' },
      { label: 'Request', labelEn: 'Request', title: 'Target Bebas', titleEn: 'Any Target', desc: 'Untuk request di luar paket yang sudah ada.', descEn: 'For requests outside the listed packages.', price: 'Cek via chat', priceEn: 'Quote', placeholder: 'Contoh: tulis nama game, target, deadline, dan kondisi akun.', placeholderEn: 'Example: write game name, target, deadline, and account condition.' },
    ],
  },
}

const otherBoosts = [
  { title: 'Material farm', titleEn: 'Material Farm', desc: 'Farm material tertentu sesuai kebutuhan upgrade.', descEn: 'Farm specific materials for account upgrades.' },
  { title: 'Quest clear', titleEn: 'Quest Clear', desc: 'Bantu beresin misi, exploration, atau objective yang nyangkut.', descEn: 'Help clear missions, exploration, or stuck objectives.' },
  { title: 'Custom target', titleEn: 'Custom Target', desc: 'Target bebas di luar paket, harga dikasih setelah cek detail.', descEn: 'Flexible targets outside listed packages, quoted after checking details.' },
]

const t = (idText, enText) => currentLang === 'id' ? idText : enText || idText
const priceText = (item) => currentLang === 'id' ? item.price : item.priceEn || item.price
const groupName = (group) => currentLang === 'id' ? group.game : group.gameEn || group.game
...
const renderPackageCard = (item) => `
  <article class="package-card ${item.featured ? 'package-featured' : ''}" data-placeholder-id="${item.placeholder}" data-placeholder-en="${item.placeholderEn}">
    ...
    <div class="package-price">${priceText(item)}</div>
...
const render = () => {
  ...
  document.querySelector('#app').innerHTML = `
    ...
    <main id="top">
      ...
      <section class="section-wrap other-section"><div class="section-heading reveal"><div><p class="eyebrow">02 / EXTRA</p><h2>${c.moreTitle}<br /><em>by request.</em></h2></div><p class="section-intro">${c.moreIntro}</p></div><div class="other-grid">${otherBoosts.map((item) => `<article class="other-card"><h3>${t(item.title, item.titleEn)}</h3><p>${t(item.desc, item.descEn)}</p></article>`).join('')}</div></section>
      <section id="paket" class="packages-section section-wrap"><div class="section-heading reveal"><div><p class="eyebrow">${t('03 / PAKET JOKI', '03 / BOOSTING PACKAGES')}</p><h2>${c.packagesTitle}</h2></div><p class="section-intro">${c.packagesIntro}</p></div><div class="package-tabs reveal" role="tablist" aria-label="${t('Pilih daftar paket game', 'Choose a game package list')}">${Object.entries(packages).map(([id, group]) => `<button class="package-tab" type="button" role="tab" aria-selected="false" aria-controls="${id}-panel" data-package-tab="${id}">${groupName(group)}</button>`).join('')}</div><div class="package-empty reveal reveal-delay"><span>↙</span><p>${c.empty}</p></div>${Object.entries(packages).map(([id, group]) => `<div class="package-panel" id="${id}-panel" role="tabpanel" hidden><div class="package-group-heading"><span>${group.label}</span><h3>${groupName(group)}</h3></div><div class="package-grid ${id}-packages">${group.items.map(renderPackageCard).join('')}</div></div>`).join('')}</section>
